<template>
  <main class="npc-sheet-wrapper">
    ...
    <section>
      <div class="npc-sheet-wrapper">
        <ActionsView />
      </div>
    </section>
    <section>
      <div class="section-card">
        <AttackSection :aim="settings.aim" :aimValue="settings.aimValue" />
        <MagicSection :aim="settings.aim" :aimValue="settings.aimValue" />
        <TalentSection />
        <InventorySection />
      </div>
    </section>
...
import CurrencyView from "@/components/resources/CurrencyView.vue";
