<template>
  <div class="age-splash-screen">
    ...
    <div class="age-splash-rulesets" v-if="!selectedSystem">
      <button
        class="age-ruleset-btn"
        aria-label="Fantasy AGE Ruleset"
        @click="
          selectSystem('fage2e');
          $emit('close');
        "
      ...
      <button
        class="age-ruleset-btn"
        aria-label="Blue Rose AGE Ruleset"
        @click="
          selectSystem('blue rose');
          $emit('close');
        "
      >
        <img
      ...
      <button
        class="age-ruleset-btn"
        aria-label="Expanse AGE Ruleset"
        @click="selectSystem('expanse')"
      >
        <img
    ...
    <div v-else class="age-character-type-select">
      <button
        class="age-character-type-btn"
        aria-label="Character"
        @click="
          selectExpanseCharType('Character');
          $emit('close');
        "
      >
