    ...
    <div class="player-sheet-wrapper">
      ...
      <section class="age-action-con-section">
        ...
        <div class="section-card" v-if="settings.showXP">
          <h1 class="age-section-header">Experience</h1>
        ...
        <div class="modal-container age-modal">
          <div class="age-modal-header">
            ...
            <button
              type="button"
              class="btn-close"
              @click="showSelectPulpyModal = false"
              aria-label="Close"
            ></button>
          </div>
          <div class="pc-pulpy-buttons">
            <button
              class="age-btn age-pulpy-btn"
              @click="
                char.toughnessPrimary = 'defense';
                showSelectPulpyModal = false;
              "
            >
            ...
            <button
              class="age-btn age-pulpy-btn"
              @click="
                char.toughnessPrimary = 'toughness';
                showSelectPulpyModal = false;
              "
            >
...
if (
  char.level >= 4 &&
  !char.toughnessPrimary &&
  settings.campaignMode === "pulpy" &&
