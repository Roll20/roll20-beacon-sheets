<template>
  <div class="tabs-col">
    <div class="section-card">
      ...
      <h1 class="age-section-header">Attacks & Gear</h1>
      <div>
        <ul class="nav nav-tabs age-tabs-container">
          <li class="nav-item age-tab" role="presentation">
            <button
              ...
              id="combat"
              data-bs-toggle="tab"
              data-bs-target="#combat-pane"
              type="button"
              role="tab"
              aria-controls="combat-pane"
              aria-selected="true"
            >
          ...
          <li
            class="nav-item age-tab"
            role="presentation"
            v-if="settings.showArcana"
          >
            <button
              class="nav-link"
              id="spells"
              data-bs-toggle="tab"
              data-bs-target="#spells-pane"
              type="button"
              role="tab"
              aria-controls="spells-pane"
              aria-selected="false"
            >
              <div class="age-tab-icon age-spells-magic-icon"></div>
              <span class="age-tab-label" v-if="settings.gameSystem === 'mage'"
                >Powers</span
              >
          ...
          <li class="nav-item age-tab" role="presentation">
            <button
              ...
              id="inventory"
              data-bs-toggle="tab"
              data-bs-target="#inventory-pane"
              type="button"
              role="tab"
              aria-controls="inventory-pane"
              aria-selected="false"
            >
          ...
          <li
            class="nav-item age-tab"
            role="presentation"
            v-if="settings.showCybernetics"
          >
            <button
              class="nav-link"
              id="inventory"
              data-bs-toggle="tab"
              data-bs-target="#enhancements-pane"
              type="button"
              role="tab"
              aria-controls="enhancements-pane"
              aria-selected="false"
            >
      ...
      <div
        :id="'primaryBlock'"
        class="accordion-collapse age-accordion-collapse collapse show"
