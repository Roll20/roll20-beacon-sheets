<template>
  <div class="tabs-col">
    <div class="section-card">
      ...
      <h1 class="age-section-header">Skills & History</h1>
      <ul class="nav nav-tabs age-tabs-container">
        <li class="nav-item age-tab" role="presentation">
          <button
            ...
            id="spells"
            data-bs-toggle="tab"
            data-bs-target="#talents-pane"
            type="button"
            role="tab"
            aria-controls="talents-pane"
            aria-selected="false"
          >
        ...
        <li class="nav-item age-tab" role="presentation">
          <button
            ...
            id="spells"
            data-bs-toggle="tab"
            data-bs-target="#expertise-pane"
            type="button"
            role="tab"
            aria-controls="expertise-pane"
            aria-selected="false"
          >
        ...
        <li class="nav-item age-tab" role="presentation">
          <button
            ...
            id="biography"
            data-bs-toggle="tab"
            data-bs-target="#biography-pane"
            type="button"
            role="tab"
            aria-controls="biography-pane"
            aria-selected="false"
          >
