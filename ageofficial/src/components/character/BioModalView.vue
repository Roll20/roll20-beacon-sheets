    ...
    <div v-if="show" class="modal-mask">
      <div class="modal-container age-modal">
        ...
        <div class="modal-body">
          ...
          <div
            class="input-group mb-3 age-form-field"
            v-if="
              bio.type === 'Character' &&
          ...
          >
            ...
            <div>
              <select
                id="bio.profession"
                v-model="bio.profession"
                class="age-atk-select form-select"
                @change="classChange"
              >
                <option
                  v-for="ageClass in classes"
                  :key="ageClass"
                  :value="ageClass.profession"
                >
                  {{ ageClass.profession }}
                </option>
              </select>
          ...
          >
            ...
            <div>
              ...
              >
                ...
                <option
                  v-for="expanseOrigin in expanseFactions"
                  :key="expanseOrigin"
                  :value="expanseOrigin.value"
                >
                  {{ expanseOrigin.label }}
                </option>
              </select>
          ...
          <div class="row age-row">
            <div
              class="mb-3 col age-form-field"
              v-if="bio.type === 'Character'"
            >
          ...
          <div class="row age-row">
            ...
            <div
              class="mb-3 col age-form-field"
              v-if="settings.showArcana && !settings.userPowerFatigue"
            >
              <span id="basic-addon1" class="age-input-label"
                >Max
                {{
