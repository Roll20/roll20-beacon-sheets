  ...
  <div class="age-character-bio bio">
    <div class="bio__avatar">
      ...
      <Tippy
        ...
        placement="right-end"
        aria-expanded="true"
        class="age-label age-level-label"
      >
        <div>
          {{ char.level }}
        </div>
    ...
    <div class="age-character-details">
      ...
      <div class="age-character-bio-container" v-if="bio.type === 'AniMon'">
        ...
        <div class="age-character-bio-value">aka {{ bio.aliases }}</div>
      ...
      <div
        class="age-character-bio-container"
        v-if="char.originFaction && settings.gameSystem === 'expanse'"
      >
        <div class="age-character-bio-value">
          {{ originFactionLabel }}
        </div>
      ...
      <div
        class="age-character-bio-value"
        v-if="settings.gameSystem === 'mage'"
      >
        <div
          class="age-character-campaignMode"
          :class="{
            cinematic: settings.campaignMode === 'cinematic',
            pulpy: settings.campaignMode === 'pulpy',
            gritty: settings.campaignMode === 'gritty',
          }"
        >
      ...
      <div
        class="age-character-originFaction-logo"
        v-if="
