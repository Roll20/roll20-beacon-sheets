      ...
      <div class="modal-container age-modal">
        ...
        <div class="modal-body inventory-modal-body">
          <div class="inventory-modal-col">
              ...
              <div class="mb-3 col" v-if="isArmor">
                ...
                <div>
                  <input
                    type="number"
                    class="form-control"
                    aria-label="Armor Penalty"
                    v-model="item.armorPenalty"
                    aria-describedby="basic-addon1"
                  />
                </div>
              </div>
            ...
            <div class="row age-row">
              <span class="age-input-label inventory-label-wide"
                >Description</span
              >
              <div>
                <QuillEditor
          ...
          <div v-if="item.type === 'weapon'" class="inventory-modal-col">
            ...
            <div class="row age-row">
              ...
              >
                ...
                >
                  <option v-for="wg in weaponGroups" :key="wg" :value="wg">
                    {{ wg }}
                  </option>
                </select>
              </div>
            ...
            <div class="row age-row">
              <div
                class="mb-3 col"
                v-if="
                  item.weaponType === 'Ranged' && settings.gameSystem !== 'mage'
                "
              >
                <span class="age-input-label" id="basic-addon1"
                  >Short Range</span
            ...
            <div class="delete-container">
              <button
                ...
                @click="
                  ...
                  $emit('delete');
                "
                v-tippy="{ content: 'Delete Inventory Item' }"
              >
