...
greater, or you make a successful Constitution (Stamina) check after an hour</p>
  ...
  },
  {
    ...
    modifiers: [
      {
        modifiedValue: "Accuracy",
        penalty: -3,
        conditional: true,
        conditionalCheck: "Are you moving away from source?",
      },
      {
        modifiedValue: "Communication",
        penalty: -3,
        conditional: true,
        conditionalCheck: "Are you moving away from source?",
      },
      {
        modifiedValue: "Constitution",
        penalty: -3,
        conditional: true,
        conditionalCheck: "Are you moving away from source?",
      },
      {
        modifiedValue: "Dexterity",
        penalty: -3,
        conditional: true,
        conditionalCheck: "Are you moving away from source?",
      },
      {
        modifiedValue: "Fighting",
        penalty: -3,
        conditional: true,
        conditionalCheck: "Are you moving away from source?",
      },
      {
        modifiedValue: "Intelligence",
        penalty: -3,
        conditional: true,
        conditionalCheck: "Are you moving away from source?",
      },
      {
        modifiedValue: "Perception",
        penalty: -3,
        conditional: true,
        conditionalCheck: "Are you moving away from source?",
      },
      {
        modifiedValue: "Strength",
        penalty: -3,
        conditional: true,
        conditionalCheck: "Are you moving away from source?",
      },
      {
        modifiedValue: "Willpower",
        penalty: -3,
        conditional: true,
        conditionalCheck: "Are you moving away from source?",
      },
