            ...
            <div class="row">
              ...
              <div class="mb-3 col" v-if="settings.gameSystem !== 'blue rose'">
                ...
                <input
                  type="text"
                  class="form-control"
                  placeholder="ex. Strength(Might)"
                  aria-label="Spell Test"
                  v-model="spell.spellTest"
                  aria-describedby="basic-addon1"
                />
              </div>
              <div class="mb-3 col" v-if="settings.gameSystem === 'blue rose'">
              ...
              <div
                class="mb-3 col align-content-end"
              ...
              <div class="mb-3 col" v-if="settings.gameSystem === 'blue rose'">
                ...
                <input
                  type="text"
                  class="form-control"
                  placeholder="ex. Willpower(Self-Discipline)"
                  aria-label="Spell Resistance"
                  v-model="spell.spellTest"
                  aria-describedby="basic-addon1"
                />
              </div>
              <div
                class="mb-3 col"
                v-if="
                  spell.weaponType === 'ranged' || spell.weaponType === 'melee'
                "
              >
                <span class="age-input-label" id="basic-addon1"
                  >Weapon Group</span
              ...
              <div class="mb-3 col" v-if="spell.spellType === 'Attack'">
                ...
                <input
                  ...
                  class="form-control"
                  placeholder="ex. 1d6"
                  aria-label="Damage (Success)"
                  :id="`damage-${spell._id}`"
                  v-model="spell.damageHit"
                  aria-describedby="basic-addon1"
                />
              </div>
              <div class="mb-3 col" v-if="spell.spellType === 'Attack'">
              ...
              <div>
                <div class="age-bio-quill">
                  <QuillEditor
                    ...
                    v-model:content="spell.description"
                  />
                </div>
              </div>
            </div>
