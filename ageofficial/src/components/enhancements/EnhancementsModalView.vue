          ...
          <div class="row">
            <div class="mb-3 col">
              ...
              <input
                type="text"
                class="form-control"
                aria-label="Augmentation Part"
                aria-describedby="basic-addon1"
                v-model="enhancement.part"
              />
            </div>
            <div class="mb-3 col">
              ...
              <input
                type="text"
                class="form-control"
                aria-label="Augmentation Cost"
                aria-describedby="basic-addon1"
                v-model="enhancement.cost"
              />
            </div>
          </div>
          <div class="row">
            <div class="col enhancement-details-col">
              ...
              <QuillEditor
                ...
                v-model:content="enhancement.description"
              />
            </div>
          </div>
        </div>
        <div class="modal-footer-actions" v-if="mode === 'create'">
          <slot name="footer">
            <button
              class="confirm-btn"
              @click="
                enhancements.addEnhancement(enhancement);
                $emit('close');
              "
            >
              Create
