...
export const fage2e = {
  ...
  export const cthulhu = {
    Accuracy: ['Arcane Blast', 'Black Powder', 'Bows', 'Brawling', 'Dueling', 'Grenades', 'Light Blades', 'Slings', 'Staves'],
    Communication: ['Animal Handling', 'Animism', 'Bargaining', 'Deception','Disguise', 'Etiquette', 'Gambling', 'Investigation', 'Leadership','Performance', 'Persuasion', 'Psychic', 'Romance'],
    Constitution: ['Drinking', 'Rowing', 'Running', 'Stamina', 'Swimming'],
    Dexterity: ['Acrobatics', 'Artisan', 'Calligraphy', 'Crafting', 'Initiative', 'Legerdemain', 'Lock Picking', 'Riding', 'Sailing', 'Stealth', 'Traps'],
