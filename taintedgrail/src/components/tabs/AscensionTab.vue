<template>
  <div class="ascension-tab">
    <div class="ascension-tab-header">
      <h3>Ascension</h3>
    </div>
    ...
    <div class="ascension-section">
      <div class="ascension-row">
        ...
        <div class="points-group">
          ...
          <input 
            type="text" 
            v-model="characterStore.ascensionPoints" 
            class="points-input"
          />
        </div>
      </div>
