  ...
  <div class="view-container">
    <div class="columns columns-2">
      <div class="total-hp span-2">
        ...
        <div v-if="combat.getTemporaryHitPoints() > 0">
          <span class="total-hp__value">{{ combat.getTemporaryHitPoints() }}</span>
    ...
    <form @submit.prevent="applyDamage">
      <div class="hp-status">
        ...
        <div class="hp-status__item" v-if="combat.getTemporaryHitPoints() > 0">
          <span class="hp-status__value">{{ combat.getTemporaryHitPoints()}}</span>
...
const applyDamage = () => {
  ...
  if (applyToTempHpFirst.value && props.initialTempHp > 0) {
    const tempHp = combat.getTemporaryHitPoints();
