<template>
  <NineSlicedBox theme="c-r">
    <div class="section defenses-section">
      ...
      <div class="section__body" v-if="!isEmpty">
        <div class="list">
...
const isEmpty = computed(() => defenseStore.displayDamageResistances.length === 0 && defenseStore.displayDamageImmunities.length === 0 && defenseStore.displayDamageVulnerabilities.length === 0 && defenseStore.combinedConditionImmunities.length === 0);
</script>
