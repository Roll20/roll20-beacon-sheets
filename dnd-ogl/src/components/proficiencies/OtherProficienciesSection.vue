...
const isEmpty = computed(() => proficienciesStore.combinedLanguages.length === 0 && proficienciesStore.combinedArmorProficiencies.length === 0 && proficienciesStore.combinedWeaponProficiencies.length === 0);
