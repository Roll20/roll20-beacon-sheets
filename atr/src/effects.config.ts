...
export const staticKeys = {
  ...
  'ballistic-armor-class': 'ballistic-armor-class',
  'manual-armor-class': 'manual-armor-class',
  'manual-ballistic-armor-class': 'manual-ballistic-armor-class',
  ...
  // Saves
  'insanity-saving': 'insanity-saving-modifier',
  'insanity-saving-roll': 'insanity-saving-roll-modifier',
  'insanity-saving-action-die': 'insanity-saving-action-die',
  'insantity-saving-action-die-min': 'insanity-saving-action-die-min',
  ...
  'insanity-saving-proficiency': 'insanity-saving-proficiency',
