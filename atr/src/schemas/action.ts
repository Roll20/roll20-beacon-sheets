...
export const ActionCompendiumSchema = z.object({
  ...
  attackAbility: z.union([z.literal('none'), z.enum([...config.abilities] as [string, ...string[]])]).optional(),
  attackBonus: z.string().optional(),
  attackProficiency: z.union([z.literal(0), z.literal(0.5), z.literal(1), z.literal(2)]).optional(),

  saving: z.union([z.literal('none'), z.enum([...config.abilities] as [string, ...string[]])]).optional(),
