...
export const DamageRollSchema = z.object({
  ability: z.union([z.literal('none'), z.custom<AbilityKey>()]),
  damage: z.string(),
...
export const NpcCompendiumSchema = z.object({
  ...
  planarSubtype: z.string().optional(),
  frequency: z.string().optional(),
  vibration: z.string().optional(),
  armorClass: z.number(),
  acDescription: z.string().optional(),
  ballisticAC: z.number().optional(),
  ballisticAcDescription: z.string().optional(),
  hitPoints: z.object({
    current: z.number(),
  ...
  skills: z.object({
    ...
    'appraise': z.number().optional(),
    'arcana': z.number().optional(),
    'athletics': z.number().optional(),
    'darklands': z.number().optional(),
    'deception': z.number().optional(),
    'demonology': z.number().optional(),
    ...
    'supernatural': z.number().optional(),
    'survival': z.number().optional(),
    'theology-and-philosophy': z.number().optional(),
    'undead': z.number().optional()
  }),
  ...
  insanityDC: z.number().optional(),
  creatureFeature: z.string().optional(),
